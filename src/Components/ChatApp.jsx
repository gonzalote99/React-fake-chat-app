...
const ChatApp = () => {
  ...
  const [image, setIamge] = useState('https://placehold.co/80x80');
  const [message, setMessage] = useState('empty');
  const [myMessages, setMyMessages] = useState('empty');
  ...
  return(
    ...
    <NavBar />
      ...
      <h2 className='text-2xl font-semibold tracking-wide'>add details here</h2>
        <div className='flex flex-col gap-y-1'>
        <label className='text-sm font-semibold'>
        enter recipent name here
        </label>
          <input
             onChange={changeName}
        ...
        <span>17:48</span>
          ...
          <span>LTE</span>
            ...
            <svg
              ...
              <path
               fill='white'
                d='M5 20v-6h36mz6 0V9h3v11mz6 0V4h1v16z'
                ></path>
            </svg>
            </div>
              <span>80%</span>
          ...
          <svg 
            ...
            <img className='w-12 h-12  rounded-full object-cover' src={image} />
          ...
          <span className='flex justify-between items-end'>{message}
          <span className='ml-2 text-[8px] tracking-tighter text-nowrap'>
            ...
            <span className='flex justify-between items-end'>{myMessages}
            <span className='ml-2 text-[8px] tracking-tighter text-nowrap'>
              {myTime === '' ? '00:00' : myTime}
            </span>
            </span>
